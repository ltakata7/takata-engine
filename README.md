...
```bash
# From a consumer app:
pip install git+ssh://git@github.com/ltakata7/takata-core.git@v0.1.0

# For local development (editable):
pip install -e /path/to/takata-core
```
...
```toml
dependencies = [
    "takata-core @ git+ssh://git@github.com/ltakata7/takata-core.git@v0.X.0",
]
```
