...
Usage::
    ...
    from takata_core.utils.investing_calendar import get_calendar_events, refresh_calendar
...
def inject_into_calendar_filter() -> int:
    ...
    """
    from takata_core.utils.calendar import EconomicEvent, SCHEDULED_EVENTS
