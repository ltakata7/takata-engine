...
from takata_engine.technical.trend import classify_trend, trend_label_short
...
from takata_engine.technical.patterns import detect_double_top, detect_double_bottom
